...
import com.webservice.microservices.currencyconversionservice.proxy.CurrencyExchangeProxy;
...
public class CurrencyConversionController {
    ...
    public CurrencyConversion calculateCurrencyConversionFeign(@PathVariable(name = "from",required = true)  String from,@PathVariable(name = "to",required = true) String to,@PathVariable(name = "quantity",required = true) BigDecimal quantity){
